...
import TimeBasedSelection from './TimeBasedSelection';
import StationBasedSelection from './StationBasedSelection';
import {
  setBookingMode,
...
import ActiveIntentCard from '../ActiveIntentCard';
  ...
  return (
    <div className='flex w-full'>
      ...
      {activeIntentsArray.length > 0 && (
        <div className='w-1/4 mr-2 border-r-2 border-gray-400 pr-3 max-h-[500px] overflow-y-auto'>
      ...
      {/* New Booking */}
      <div className={`${activeIntentsArray.length > 0 ? 'w-3/4' : 'w-full'} space-y-2 text-black`}>
