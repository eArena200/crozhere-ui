...
function FilterPanel({filters, supportedStationTypes, onClose}: FilterPanelProps) {
  ...
  return (
    <div className="flex flex-col items-start justify-start rounded-md border border-gray-300 shadow-md px-4 py-2 mt-2 w-fit">
      ...
      <div className="w-full flex flex-row items-start justify-start gap-10  bg-white">
        {/* Date Filter Section */}
        <div className="flex flex-col items-center justify-start gap-4">
          <div>
            <label htmlFor="fromDateTime" className="block text-sm font-semibold">From</label>
            <input
              id="fromDateTime"
              type="datetime-local"
              name="fromDateTime"
          ...
          <div>
            <label htmlFor="toDateTime" className="block text-sm font-semibold">To</label>
            <input
              id="toDateTime"
              type="datetime-local"
              name="toDateTime"
        ...
        <div className="flex flex-col h-full items-start justify-start gap-2">
          <p className="block text-sm font-semibold">Station Types</p>
        ...
        <div className="flex flex-col h-full items-start justify-start gap-2">
          <p className="block text-sm font-semibold">Booking Status</p>
          <div className="flex flex-col gap-1 overflow-y-auto text-sm">
        ...
        { /* BookingType Section  */ }
        <div className="flex flex-col h-full items-start justify-start gap-2">
          <p className="block text-sm font-semibold">Booking Type</p>
          <div className="flex flex-col gap-1 overflow-y-auto text-sm">
