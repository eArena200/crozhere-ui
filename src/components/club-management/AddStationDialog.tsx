...
const AddStationDialog: React.FC<AddStationDialogProps> = ({ isOpen, onClose, onSubmit }) => {
  return (
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <Dialog.Panel className="mx-auto w-full max-w-md rounded-2xl bg-white shadow-xl max-h-[90vh] flex flex-col">
          ...
          <div className="flex items-center justify-between border-b p-6">
            <Dialog.Title className="text-xl font-semibold text-gray-900">Add New Station</Dialog.Title>
          ...
          <div className="border-t px-6 py-4 flex justify-end gap-3">
            ...
            <Button type="submit" form="station-form" variant="primary">
              Add Station
            </Button>
          </div>
        </Dialog.Panel>
