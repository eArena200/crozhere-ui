...
function RateCardDetailsHeaderMobile() {
    ...
    <div className="flex justify-between items-center p-2 border-b border-gray-200">
        {
          rateCards && Object.values(rateCards).length > 0 ? (
            ...
            <div>
              <h2 className="text-md font-semibold text-gray-900">Ratecards</h2>
              <p className="text-xs text-gray-500">Manage your club ratecards</p>
            </div>
          )
        }
        <Button variant="m_primary" onClick={() => setCreateRateCardDialogOpen(true)}>
          Add Rate Card
        </Button>
...
export default RateCardDetailsHeaderMobile;