...
interface StationDetailsCardMobileProps {
  stationDetails: StationDetailsResponse;
}

function StationDetailsCardMobile({ 
  stationDetails
}: StationDetailsCardMobileProps) {
            ...
            <div className="pb-2 border-b-2 border-gray-200">
              <div className="flex justify-between items-center">
                <div className="flex items-center space-x-2">
                  <h3 className="text-md font-semibold text-gray-900">{stationDetails.stationName}</h3>
              ...
              <h3 className="text-xs font-mono text-gray-700">{stationDetails.stationDescription}</h3>
            </div>
...
export default React.memo(StationDetailsCardMobile);
