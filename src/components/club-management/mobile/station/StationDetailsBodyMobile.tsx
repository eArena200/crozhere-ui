...
function StationDetailsBodyMobile() {
  const {
      stations,
      stationsLoading,
      stationsError
    ...
    if(stationList.length <= 0){
      return (
          <div className='w-full min-h-[60vh] flex flex-col items-center justify-center gap-0.5 bg-white'>
...
export default StationDetailsBodyMobile;